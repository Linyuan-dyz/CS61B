...
public class Repository {
    ...
    public static void status() {
        ...
        if (removeFile.exists()) {
            TreeMap<String, String> removeTreeMap =
                    Utils.readObject(Remove.REMOVEFILE, TreeMap.class);
    ...
    public static void createBranch(String brancheName) {
        checkGitletRepository();
        if (Utils.join(Head.HEADSFILE, brancheName).exists()
                || Utils.join(Head.MASTERFILE, brancheName).exists()) {
